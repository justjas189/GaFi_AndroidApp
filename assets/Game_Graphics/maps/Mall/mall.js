    ...
    loadMapImage() {
        return new Promise((resolve, reject) => {
            ...
            this.mapImage.onerror = () => {
                console.warn('Map003.png not found, will render without background');
                this.mapImageLoaded = false;
                resolve(); // Continue without background
            };
            
            this.mapImage.src = 'Map003.png';
...
window.addEventListener('DOMContentLoaded', () => {
    console.log('Starting Mall Map with RPG Maker MZ Collision System');
    const game = new Game();
    game.init();
});
